...
const NODE_DEFS = {
    ...
    hz_filter: { typeId: 92, label: 'Hz Filter', category: 'Audio', inPorts: ['audio'], outPorts: ['audio'], params: [{ id: 'min', label: 'Min (Hz)', type: 'log_range', min: 20, max: 20000, default: 20 }, { id: 'max', label: 'Max (Hz)', type: 'log_range', min: 20, max: 20000, default: 20000 }, { id: 'poles', label: 'Poles', type: 'range', min: 1, max: 8, default: 4 }] },
    db_filter: { typeId: 100, label: 'dB Filter', category: 'Audio', inPorts: ['audio'], outPorts: ['audio'], params: [{ id: 'min', label: 'Min (dB)', type: 'range', min: -100, max: 0, default: -60 }, { id: 'max', label: 'Max (dB)', type: 'range', min: -100, max: 0, default: 0 }] },
